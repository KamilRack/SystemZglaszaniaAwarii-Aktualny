...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SystemZglaszaniaAwariiGlowny.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SystemZglaszaniaAwariiGlowny.Models.Magazyn", b =>
                {
            ...
            modelBuilder.Entity("SystemZglaszaniaAwariiGlowny.Models.Maszyna", b =>
                {
            ...
            modelBuilder.Entity("SystemZglaszaniaAwariiGlowny.Models.Mechanik", b =>
                {
                    b.Property<int>("MechanikId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MechanikId"), 1L, 1);

                    b.Property<string>("MechanikName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("MechanikNazwisko")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SystemZglaszaniaAwariiGlowny.Models.Zgloszenia", b =>
                {
            ...
            modelBuilder.Entity("MagazynMaszyna", b =>
                {
                    b.HasOne("SystemZglaszaniaAwariiGlowny.Models.Magazyn", null)
                        .WithMany()
                        .HasForeignKey("MagazynsMagazynId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SystemZglaszaniaAwariiGlowny.Models.Maszyna", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SystemZglaszaniaAwariiGlowny.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SystemZglaszaniaAwariiGlowny.Models.Magazyn", b =>
                {
                    b.HasOne("SystemZglaszaniaAwariiGlowny.Models.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("Id");
            ...
            modelBuilder.Entity("SystemZglaszaniaAwariiGlowny.Models.Zgloszenia", b =>
                {
                    ...
                    b.HasOne("SystemZglaszaniaAwariiGlowny.Models.Magazyn", "Magazyn")
                        .WithMany("Zgloszenias")
                        .HasForeignKey("MagazynId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SystemZglaszaniaAwariiGlowny.Models.Maszyna", "Maszyna")
                        .WithMany("Zgloszenias")
                        .HasForeignKey("MaszynaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SystemZglaszaniaAwariiGlowny.Models.Mechanik", "Mechanik")
                        .WithMany("Zgloszenias")
